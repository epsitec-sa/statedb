...
class Storage {
  ...
  initDb(initialState) {
    ...
    const existingState = this._store.data.states[this._appKey] || {};
    const newState = {...existingState, ...initialState, app: this._appKey};
    this._store.data.states[this._appKey] = newState;
    this._store.write();
  }
